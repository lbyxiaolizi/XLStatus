...
- 发布方式：Docker Compose、源码构建、systemd 安装脚本和 Linux x86_64 GitHub Release 资产。
...
后台设置页可以生成带参数的 Agent bootstrap 链接。默认情况下，这个链接会下载同一个 `v0.1.0-alpha.3` GitHub Release 安装脚本。
